...
class Statokinesigram {
  ...
  Statokinesigram({
    this.swayPath, this.meanDisplacement, this.stdDisplacement, this.minDist,
    this.maxDist, this.meanFrequencyAP, this.meanFrequencyML, this.frequencyPeakAP,
    this.frequencyPeakML, this.f80AP, this.f80ML, this.np, this.meanTime, this.stdTime,
    this.meanDistance, this.stdDistance, this.meanPeaks, this.stdPeaks, this.grX, this.grY,
    this.grZ, this.gmX, this.gmY, this.gmZ, this.gvX, this.gvY, this.gvZ, this.gkX, this.gkY,
    this.gkZ, this.gsX, this.gsY, this.gsZ
  });
}